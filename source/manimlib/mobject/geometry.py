...
class ArcBetweenPoints(Arc):
    ...
    Parameters
    ----------
    start_point,end_point: 3D array
        Points
...
class Vector(Arrow):
    ...
    ----------
    direction : 3D array
        Vector is: ``Arrow(ORIGIN,direction)``
...
class Polygon(VMobject):
    ...
    *vertices : list of 3D arrays
        Vertices of the poligon as list
    ...
    def get_vertices(self):
        ...
        Returns
        -------
        List of points : List of 3D arrays
        """
