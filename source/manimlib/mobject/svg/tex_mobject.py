...
class TexMobject(SingleStringTexMobject):
    ...
    *tex_strings: string
    ...
    def set_color_by_tex(self, tex, color, **kwargs):
        """
        Set the color by specifying the TeX symbol

        Note
        ----
           In case of ``TexMobject`` it does not work if the radical symbol is used. In case you use indexes and superscripts, write the superscript first.
