...
class ShowPartial(Animation):
    """
    Abstract class of ShowCreation
...
class VFadeOut(VFadeIn):
    """
    Same of FadeOut but with VMobjects
...
class GrowArrow(GrowFromPoint):
    ...
    ----------
    arrow : Arrow
        See :meth:`manimlib.mobject.geometry.Arrow`
    """
...
class SpinInFromNothing(GrowFromCenter):
    ...
    ::
        ...
        "point_color": counterclockwise_path(),
    """
    CONFIG = {
